            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <p>Use font awesome icons; You can reffer to the <a href="https://www.apogen.pt/fontawesome-iconpicker/" target="_blank">Font Awesome Icon Picker</a></p>
                            ...
                            <div class="tab-pane fade show active" id="custom-content-below-home" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                                ...
                                <form action="" method="POST">
                                    ...
                                    foreach ($groups as $grp => $tables) {
                                        ...
                                        <label>' . $grp . ' Group Icon: <span class="' . $group_fa . '"></span></label>
                                        ...
                                        if(selectedDisplay==="default"){' . $gn . '_cclabel.style.display = "none";' . $gn . '_cc.style.display = "none";}
                                        ...
                                        $("#' . $gn . '_hpd").change(function(){
                                            ...
                                            if(TheselectedDisplay==="default"){' . $gn . '_cclabel.style.display = "none";' . $gn . '_cc.style.display = "none";}
                                ...
                                <form action="" method="POST">
                                    ...
                                    foreach ($groups as $grp => $tables) {
                                        foreach ($tables as $tn) {
                                            ...
                                            echo '
                                        <label>' . $table_title . ' <span class="fa fa-table"></span></label>
                                        <div class="row">
...
?>
>>>>>>> 3a86378e25454e60150c0437f8741bace637e914
